...
export default class QuadTree {
    ...
    _contents: Array<any>;
    _parent: null | QuadTree;
    _quadrants: null | Array<QuadTree>;

    bounds: [vec2, vec2];

    constructor(bounds: [vec2, vec2], nodeCapacity: number) {
    ...
    insert(collider: ICollider) {
        ...
        if (this._quadrants == null) {
            ...
            // console.log(
            //     "Adding to ",
            //     `(${this.bounds[1][1]}, ${this.bounds[1][1]}), (${this.bounds[1][1]}, ${this.bounds[1][1]})`
            // );
    ...
    _addToQuadrant(collider: ICollider) {
        // console.log("Adding to quadrant");
    ...
    test(callback: (obj1: ICollider, obj2: ICollider) => void) {
    ...
    _parentTest(collider: ICollider, callback: (obj1: ICollider, obj2: ICollider) => void) {
        for (let i = 0; i < this._contents.length; i++) {
