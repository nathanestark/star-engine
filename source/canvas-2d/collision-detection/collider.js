...
export default class Collider {
    ...
    onCollisions(collisions) {
        ...
        if (!this.static) {
            if (this.parent.onCollisions) this.parent.onCollisions(collisions);
