...
export default class TextHud extends Hud {
    constructor(properties = {}) {
        ...
        if (properties.textSize) this.textSize = properties.textSize;
        else this.textSize = 14;

        if (properties.fontType) this.fontType = properties.fontType;
        ...
        if (properties.justify) this.justify = properties.justify;
